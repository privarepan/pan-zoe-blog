            ...
            <!-- Settings Dropdown -->
                <div class="ml-3 relative flex">
                    ...
                    <div class="md:flex flex-col items-center md:flex-row md:-mx-4 hidden">
                        ...
                        <a href="https://github.com/privarepan/pan-zoe-blog.git" target="_blank" class="text-gray-800 hover:text-blue-500 md:mx-4 md:my-0 font-medium text-indigo-600 hover:text-indigo-500">
