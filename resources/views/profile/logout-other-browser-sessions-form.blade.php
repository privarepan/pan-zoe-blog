<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            如有必要，您可以在所有设备上注销所有其他浏览器会话。下面列出了您最近的一些课程；但是，此列表可能并不详尽。如果你觉得你的帐户被泄露了，你也应该更新你的密码。
        </div>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="text-green-500 font-semibold">这个设备</span>
                                    @else
                                        上次激活 {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
